...
StatusIndicator::StatusIndicator() : _xCenter(STATUS_CENTER_X), _yCenter(STATUS_CENTER_Y) {
...
void StatusIndicator::drawSymbol(uint16_t color) {
    ...
    case StatusIndicatorState::TIMER:
        ...
        Graphics::drawChar(_xCenter - (16 / 2), _yCenter, 's', color, &Roboto_Light20pt7b,
                           Roboto_Light20pt7bGlyphs, Roboto_Light20pt7bBitmaps);
        break;
    case StatusIndicatorState::LEVEL:
        // Draw '%' to signal percentage
        // Note: symbol is 25px wide
        Graphics::drawChar(_xCenter - (25 / 2), _yCenter, '%', color, &Roboto_Light20pt7b,
                           Roboto_Light20pt7bGlyphs, Roboto_Light20pt7bBitmaps);
        break;
    case StatusIndicatorState::CLEAN:
        // Draw '!' to signal percentage
        // Note: symbol is 3px wide
        Graphics::drawChar(_xCenter - (3 / 2), _yCenter, '!', color, &Roboto_Light20pt7b,
                           Roboto_Light20pt7bGlyphs, Roboto_Light20pt7bBitmaps);
        break;
    case StatusIndicatorState::ERROR:
        // Draw '?' to signal error
        // Note: symbol is 14px wide
        Graphics::drawChar(_xCenter - (14 / 2), _yCenter, 'x', color, &Roboto_Light20pt7b,
                           Roboto_Light20pt7bGlyphs, Roboto_Light20pt7bBitmaps);
        break;
    default:
